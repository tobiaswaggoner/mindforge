...
- **Revert All**: Macht alle Änderungen des Tasks rückgängig (`reverted_at` wird gesetzt)
  - Zeigt Toast mit Zusammenfassung: "Reverted 3 clusters, 15 variants, 60 answers"
- **Retry Now**: Startet fehlgeschlagenen Task sofort neu
- **Cancel**: Bricht laufenden/wartenden Task ab

**Error States**:
- **Circuit Breaker Open**: Wenn der LLM-Service nicht verfügbar ist, zeigt das UI:
  - Banner/Toast: "Service temporarily unavailable"
  - Geschätzte Zeit bis Retry möglich (falls vom Backend geliefert)
  - "Generate"-Buttons werden disabled mit Tooltip-Erklärung
